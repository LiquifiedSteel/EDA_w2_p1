...
let firstName = "Alex";
console.log( "firstName equals", firstName );
// 2 - Create a second variable called `lastName` and assign it the value of your last name
let lastName = "Rivard";
console.log( "lastName equals", lastName );
...
let luckyNumber = 2;
console.log( "luckyNumber equals", luckyNumber );
...
console.log( "adventurous equals", adventurous );
// 7 - Create a variable named `food`, and set its value to a string of your favorite food
//     Console log the value of `food`
let food = "Watermelon";
console.log( "food equals", food );
// 8 - Create a variable called `pets` and set it to the value of the number of pets you have
//     Console log the value of `pets`
let pets = 0;
console.log( "pets equals", pets );
// 9 - Create a variable called `friendsPets` and assign it the value of the number of pets your friend has
let friendsPets = 3;
console.log( "friendsPets equals", friendsPets );
// 10 - Add two pets to your `pets` variable
pets += 2;
console.log( "pets equals", pets );
// 11 - Create a constant variable called `allowedPets` and set it to a number value of your choice
const allowedPets = 2;
console.log( "allowedPets equals", allowedPets );
...
if (pets < friendsPets) {
  ...
  console.log( "Friend has more pets, they have", mostPets );
}
else if (pets > friendsPets) {
  mostPets = pets;
  console.log( "You has more pets, you have", mostPets );
}
else {
  mostPets = pets;
  console.log("Both pet amounts are equal.")
}
